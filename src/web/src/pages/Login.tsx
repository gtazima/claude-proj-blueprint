      ...
      <div className="w-full max-w-sm bg-white rounded-xl border border-stone-200 shadow-sm p-8">
            ...
            <form onSubmit={handleEmail} className="flex flex-col gap-3">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="block text-xs font-medium text-stone-600">Senha</label>
                  <button
                    type="button"
        ...
        {view === "forgot" && (
          <>
            <button
              ...
              className="flex items-center gap-1.5 text-xs text-stone-400 hover:text-stone-600 transition-colors mb-5"
            >
            ...
            <h1 className="text-sm font-semibold text-stone-800 mb-1">Redefinir senha</h1>
        ...
        {view === "sent" && (
          <>
            ...
            <h1 className="text-sm font-semibold text-stone-800 mb-1">E-mail enviado</h1>
            <p className="text-xs text-stone-500 mb-6">
              Enviamos um link de redefinição para <span className="font-medium text-stone-700">{resetEmail}</span>.
              Verifique sua caixa de entrada (e a pasta de spam).
            </p>
            <button
              type="button"
              onClick={() => { setError(null); setView("login"); }}
              className="w-full border border-stone-200 rounded-md px-4 py-2 text-sm text-stone-600 hover:bg-stone-50 transition-colors"
            >
              Voltar ao login
            </button>
          </>
